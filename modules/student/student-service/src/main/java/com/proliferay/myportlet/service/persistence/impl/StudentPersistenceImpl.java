...
import com.proliferay.myportlet.model.impl.StudentImpl;
import com.proliferay.myportlet.model.impl.StudentModelImpl;
...
public class StudentPersistenceImpl
	 ...
	 */
	@Override
	public List<Student> findByStudentId(long studentId, int start, int end) {
	...
	public Student findByStudentId_First(
		...
		Student student = fetchByStudentId_First(studentId, orderByComparator);
	...
	public Student fetchByStudentId_First(
		...
		List<Student> list = findByStudentId(
	...
	public Student findByStudentId_Last(
		...
		Student student = fetchByStudentId_Last(studentId, orderByComparator);
	...
	public Student updateImpl(Student student) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {studentModelImpl.getStudentId()};
			...
			if ((studentModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					studentModelImpl.getOriginalStudentId()
				};
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.proliferay.myportlet.model.Student"),
			true);
	}
