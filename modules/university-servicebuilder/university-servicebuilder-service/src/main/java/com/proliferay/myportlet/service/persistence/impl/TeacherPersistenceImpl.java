...
import com.proliferay.myportlet.exception.NoSuchTeacherException;
import com.proliferay.myportlet.model.Teacher;
import com.proliferay.myportlet.model.impl.TeacherImpl;
import com.proliferay.myportlet.model.impl.TeacherModelImpl;
import com.proliferay.myportlet.service.persistence.TeacherPersistence;
import com.proliferay.myportlet.service.persistence.impl.constants.UNIVERSITYPersistenceConstants;
...
public class TeacherPersistenceImpl
	 ...
	 */
	@Override
	public List<Teacher> findByTeacherId(long teacherId) {
	 ...
	 */
	@Override
	public List<Teacher> findByTeacherId(long teacherId, int start, int end) {
	 ...
	 */
	@Override
	public List<Teacher> findByTeacherId(
	...
	public Teacher findByTeacherId_First(
		...
		Teacher teacher = fetchByTeacherId_First(teacherId, orderByComparator);
	...
	public Teacher fetchByTeacherId_First(
		...
		List<Teacher> list = findByTeacherId(
	...
	public Teacher findByTeacherId_Last(
		...
		Teacher teacher = fetchByTeacherId_Last(teacherId, orderByComparator);
	...
	public Teacher updateImpl(Teacher teacher) {
		...
		if (!_columnBitmaskEnabled) {
			...
			args = new Object[] {teacherModelImpl.getTeacherId()};

			finderCache.removeResult(_finderPathCountByTeacherId, args);
			finderCache.removeResult(
				_finderPathWithoutPaginationFindByTeacherId, args);
			...
			if ((teacherModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByTeacherId.
					 getColumnBitmask()) != 0) {

				Object[] args = new Object[] {
					teacherModelImpl.getOriginalTeacherId()
				};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByTeacherId = new FinderPath(
			...
			new String[] {Long.class.getName()},
			TeacherModelImpl.TEACHERID_COLUMN_BITMASK |
			TeacherModelImpl.CREATEDATE_COLUMN_BITMASK);
	...
	@Override
	@Reference(
		target = UNIVERSITYPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.proliferay.myportlet.model.Teacher"),
			true);
	}

	@Override
	@Reference(
		target = UNIVERSITYPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	static {
		try {
			Class.forName(UNIVERSITYPersistenceConstants.class.getName());
		}
