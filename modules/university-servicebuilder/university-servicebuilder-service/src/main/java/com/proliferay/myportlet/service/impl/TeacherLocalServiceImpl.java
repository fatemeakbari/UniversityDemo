...
import com.proliferay.myportlet.exception.TeacherCollegeException;
import com.proliferay.myportlet.exception.TeacherEmailAddressException;
import com.proliferay.myportlet.exception.TeacherNameException;
import com.proliferay.myportlet.model.Teacher;
import com.proliferay.myportlet.service.base.TeacherLocalServiceBaseImpl;
 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.proliferay.myportlet.service.TeacherLocalService</code> interface.
 *
 * <p>
 ...
 */
@Component(
	property = "model.class.name=com.proliferay.myportlet.model.Teacher",
...
public class TeacherLocalServiceImpl extends TeacherLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>com.proliferay.myportlet.service.TeacherLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.proliferay.myportlet.service.TeacherLocalServiceUtil</code>.
	 */
